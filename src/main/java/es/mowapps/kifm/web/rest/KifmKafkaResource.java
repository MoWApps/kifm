...
@RestController
@RequestMapping("/api/kifm-kafka")
public class KifmKafkaResource {

    private final Logger log = LoggerFactory.getLogger(KifmKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public KifmKafkaResource(KafkaProperties kafkaProperties) {
