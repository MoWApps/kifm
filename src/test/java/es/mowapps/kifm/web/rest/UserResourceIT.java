...
import es.mowapps.kifm.domain.Authority;
import es.mowapps.kifm.domain.User;
import es.mowapps.kifm.repository.UserRepository;
import es.mowapps.kifm.repository.search.UserSearchRepository;
...
import es.mowapps.kifm.service.mapper.UserMapper;
...
class UserResourceIT {
    ...
    /**
     * This repository is mocked in the es.mowapps.kifm.repository.search test package.
     *
     * @see es.mowapps.kifm.repository.search.UserSearchRepositoryMockConfiguration
     */
    @Autowired
